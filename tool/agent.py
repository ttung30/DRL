...
import random
import numpy as np
from tool.losses import Regressions
from collections import deque
from std_msgs.msg import Float32MultiArray
from ..tool.model import DRLModel
...
class DuelingQAgent():
    def __init__(self, state_size, action_size, mode, load_eps):
        ...
        self.Pred_model = DRLModel()
        self.Target_model = DRLModel()
    ...
    def TrainModel(self):
        ...
        pre_out=self.Pred_model(states)
        predicted_values = pre_out.gather(1, actions.view(64, 1, 1).expand(64, 1, pre_out.size(2))).squeeze()
        self.loss=Regressions.mean_square_error(td_target,predicted_values )
